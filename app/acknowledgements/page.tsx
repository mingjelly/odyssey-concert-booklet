...
const committee = [
  ...
  { role: 'Music Director', name: 'Napin' },
  { role: 'Music Director', name: 'Luis' },
  { role: 'Financial Secretary', name: 'Vienna' },
  { role: 'Publicity Director', name: 'Rinny'},
...
const subcommittees = [
  {
    ...
    subsections: [
      ...
      { label: 'Photoshoot Helpers', names: ['Nicky', 'Rinny', 'Shira', 'Napin', 'Danial', 'Yi Cheng', 'Justin', 'Katherine', 'Riley', 'Shennon', 'Meiwen', 'Xin Hui', 'Josiah', 'Chloe', 'Ming Yang', 'Oak', 'Benny'] },
